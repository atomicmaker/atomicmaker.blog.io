    ...
    return (
        <div className='anime-main'>
            ...
            <div className='anime-content'>
                <BlurFade delay={0} className='anime-hero-card'>
                    ...
                    <p className='anime-desc'>追番列表 — 记录看过的动漫与感想</p>
                </BlurFade>

                <BlurFade delay={0.3} className='anime-list-card'>
                    <p className='placeholder-text'>🎬 番剧列表即将上线，敬请期待...</p>
                </BlurFade>
            </div>
        </div>
    )
